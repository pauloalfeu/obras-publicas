...
########################## TRATAMENTO DO ARQUIVO P/ DATAFRAME ##############################
   ...
   #Utilizando st.empty(), preenche o espaço com o widget quando necessário.
    ...
    with tab5:
        ...
        plt.title("Palavras frequentes", fontsize=17)
        ...
        plt.figtext(0.5, 0.01, "Figura gerada com a biblioteca WordCloud", ha="center", fontsize=12)
        st.pyplot(plt)
    ...
    with tab7:
        ...
        <div style='justify-content: center; text-align:center'>
            ...
            <figure>
            <img src="https://github.com/pauloalfeu/obras-publicas/blob/main/base/KMeansObrasCAC.png?raw=true" width="650"> <br>
